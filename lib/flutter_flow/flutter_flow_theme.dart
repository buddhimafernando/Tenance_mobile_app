...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF46A5DC);
  late Color secondary = const Color(0xFF0D1634);
  late Color tertiary = const Color(0xFFA0A0A0);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xB3252831);
  late Color accent2 = const Color(0x3246A5DC);
  late Color accent3 = const Color(0xFF000000);
  late Color accent4 = const Color(0xFFFFC107);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFAE0E17);
